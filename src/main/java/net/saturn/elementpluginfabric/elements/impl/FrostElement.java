...
import net.saturn.elementpluginfabric.elements.impl.basic.frost.Ability1;
import net.saturn.elementpluginfabric.elements.impl.basic.frost.Ability2;
...
public class FrostElement implements Element {
    ...
    public FrostElement(ElementPluginFabric plugin) {
        this.plugin = plugin;
