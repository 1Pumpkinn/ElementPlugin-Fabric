...
public class UpgraderIItem extends Item {
    ...
    public UpgraderIItem(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult use(World world, PlayerEntity user, Hand hand) {
        ...
        if (user instanceof ServerPlayerEntity player) {
            ...
            if (currentLevel >= 1) {
                player.sendMessage(Text.literal("You already have upgrade level 1!")
            ...
            player.sendMessage(Text.literal("Upgraded to level 1!")
